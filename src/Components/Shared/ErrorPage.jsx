...
const ErrorPage = () => {
  return (
    <section class=" text-white flex justify-center items-center dark:bg-gray-900 ">
      <div class="container flex items-center  lg:max-w-md min-h-screen px-6 py-12 mx-auto">
        <div>
          <p class="text-sm font-medium text-blue-500 dark:text-blue-400">
            404 error
          </p>
          <h1 class="mt-3 text-2xl font-semibold text-gray-300 dark:text-white md:text-3xl">
